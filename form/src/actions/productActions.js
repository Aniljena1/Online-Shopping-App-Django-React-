...
export const deleteProduct = (_id) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.delete(`http://127.0.0.1:8000/api/products/delete/${_id}/`, config)
...
export const createProductReview = (productId, review) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await axios.post(`http://127.0.0.1:8000/api/products/review/${productId}/`, review, config)
