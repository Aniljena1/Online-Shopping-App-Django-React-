...
export const userListrReducer = (state = { alluser: [] }, action) => {
    switch (action.type) {
...
export const adminDetailsReducer = (state = { auser: {} }, action) => {
    switch (action.type) {
        case USER_DETAILS_ADMIN_REQUEST:
            return { ...state, loading: true }

        case USER_DETAILS_ADMIN_SUCCESS:
            return { loading: false, auser: action.payload }

        case USER_DETAILS_ADMIN_FAILURE:
            return { loading: false, error: action.payload }
